...
namespace Majales.Migrations
{
    ...
    [Migration("20200128113305_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Majales.Models.Value", b =>
                {
                    ...
                    b.Property<float?>("CEOinCost");

                    b.Property<float?>("CEOoutCost");
                    ...
                    b.Property<float?>("MSecinCost");

                    b.Property<float?>("MSecoutCost");

                    b.Property<float?>("MeminCost");

                    b.Property<float?>("MemoutCost");

                    b.Property<float?>("SecinCost");

                    b.Property<float?>("SecoutCost");
            ...
            modelBuilder.Entity("Majales.Models.Vote", b =>
                {
                    ...
                    b.Property<int>("YesResult");

                    b.Property<int>("abstentResult");
            ...
            modelBuilder.Entity("Majales.Models.VoteTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Majales.Models.Attachment", b =>
                {
                    b.HasOne("Majales.Models.Topic", "Topics")
            ...
            modelBuilder.Entity("Majales.Models.Majles", b =>
                {
                    ...
                    b.HasOne("Majales.Models.Majles", "ParentMajles")
                        .WithMany("ChiledMajles")
                        .HasForeignKey("ParentMajlesId");
                });
            ...
            modelBuilder.Entity("Majales.Models.VoteTransaction", b =>
                {
                    b.HasOne("Majales.Models.Member", "Member")
                        .WithMany("VoteTransaction")
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Majales.Models.Vote", "Vote")
                        .WithMany("VoteTransaction")
